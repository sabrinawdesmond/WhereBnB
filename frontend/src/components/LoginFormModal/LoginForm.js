    ...
    <>
      <div className="loginForm">
        ...
        <div className="links">
          ...
          >
            <button className="externalLinkGitHub" type="submit">
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <button className="externalLinksLinkedin" type="submit">
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <button className="externalLinksEmail" type="submit">
        ...
        <div className="signuplink">
          <p onClick={handleSignupAndCloseLoginForm}>
            New to Wherebnb? Signup!
          </p>
        </div>
        {showLoginFormModal && (
